    ...
    <div>
        ...
        <div className="flex ">
            <div className="w-2/5">
                <div className="container pt-48 pl-5">
                    <img src="/static/images/DSC02765.JPG"  className="h-1/2 pb-5 pt-16" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500	pt-48 text-right mr-6 ml-2">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">El diseño de la CUC</h2>
        ...
        <div className="flex ">
            <div className="w-2/5">
                <div className="container pl-5">
                    <img src="/static/images/DSC02769.JPG"  className="h-1/2 pb-5 pt-16" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500	pt-24 text-right mr-6 ml-2">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">Bloques Horizontales</h2>
      ...
      <div className="bg-zinc-50">
        <div className="flex pt-12">
            ...
            <div className="w-3/5 text-neutral-500	pt-24 text-right mr-6 ml-2">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">Bloques verticales</h2>
                    <p className="pt-1 pb-1 mr-10 ml-10">
      ...
      <div className="bg-zinc-50">
        <div className="flex">
            <div className="w-2/5">
                <div className="container pl-5">
                    <img src="/static/images/DSC02739.JPG"  className="h-1/2 pb-5 pt-16" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500	pt-24 text-right mr-6 ml-2">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">Piezas singulares (auditorios, bibliotecas, deportivos, otros)</h2>
                    <p className="pt-1 pb-1 mr-10 ml-10">
      ...
      <div className="bg-zinc-50">
        <img src="/static/images/arquitectura.png"  className="h-1/2 pb-5 pt-16" alt="" />
      </div>
    </div>
  );
};

export default ArquitecturaInformacion;