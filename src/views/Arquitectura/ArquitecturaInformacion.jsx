...
const ArquitecturaInformacion = () => {
  return (
    <div>
      <div className="bg-zinc-50" id="cuc">
        <div className="flex ">
            <div className="w-2/5">
        ...
        <div className="flex ">
            <div className="w-2/5">
                <div className="container pt-6 pl-24 pr-10">
                    <img src="/static/images/DSC02769.JPG"  className="dh-1/2 pb-5 pt-5" alt="" />
                </div>
            </div>
      ...
      <div className="bg-zinc-50" id="piezas">
        <div className="flex">
            <div className="w-2/5">
                <div className="container pt-6 pl-24 pr-10">
                    <img src="/static/images/DSC02739.JPG"  className="dh-1/2 pb-5 pt-5" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500	pt-6 text-left pr-16 ml-16">
