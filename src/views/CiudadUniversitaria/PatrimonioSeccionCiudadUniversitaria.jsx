        ...
        <div className="flex">
          <div className="w-3/6">
            <div className="container pt-12 pl-24 pr-10">
              ...
              />
              <img
                src="/static/images/DSC02765.JPG"
                className="h-1/2 pb-5 pt-5"
                alt=""
              />
            </div>
          ...
          >
            <div className="container">
              ...
              <p className="pt-1 pb-3 text-section">
                ...
                la UNESCO. El informe resalta todos los valores, urbanísticos,
                arquitectónicos y artísticos de la Ciudad Universitaria de
              ...
              <p className="pt-1 pb-3 text-section">
                ...
                Comité de Preservación y Desarrollo, COPRED. Su misión es
                preservar y desarrollar todo el patrimonio edificado, artístico
                y natural de la Universidad Central de Venezuela, así como
              ...
              <p className="pt-1 pb-20 text-section">
                ...
                conservación de los valores tangibles en él representados
                mediante una gestión institucional orientada al largo plazo y
                vinculada a criterios de sostenibilidad para reglamentar y
                fomentar procesos de recuperación y adecuación de la planta
                física con una visión integral de su problemática y
                administración.
              </p>
            </div>
          </animated.div>
