        ...
        <div className="flex">
            <div className="w-3/5 text-neutral-500	pt-48 text-left mr-6 ml-2">
                 <div className="container">
                    <h2 className="pt-10 pb-10 subtitle-section mr-10 ml-10">Londres a Caracas, <br/> con escala en París
                    </h2>
            ...
            <div className="w-2/5">
                <div className="container pr-5 pt-48">
                    <img src="/static/images/Carlos_Raúl_Villanueva.jpg" className="" alt="" />
                    <img src="/static/images/02-hist-1-568x433.jpg" className="w-3/5 pt-5" alt="" />
                </div>
            </div>
        </div>
      </div>
