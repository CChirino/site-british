  ...
  return (
    <div id="londres">
      <div className="bg-zinc-50">
        <div className="flex">
            <div className="w-3/5 text-neutral-500 pt-12 text-right pr-16 ml-16">
                 <div className="container">
                    <h2 className="pt-7 subtitle-section">Londres a Caracas, <br/> con escala en París
                    </h2>
            ...
            <div className="w-2/5 pt-12 pl-10 pr-24">
                <div className="container pr-5">
                    <img src="/static/images/Carlos_Raúl_Villanueva.jpg" className="h-1/2 pb-5 pt-5" alt="" />
                    <img src="/static/images/02-hist-1-568x433.jpg" className="h-1/2 pb-5 pt-5" alt="" />
                </div>
            </div>
        </div>
      </div>
