        ...
        <div className="flex ">
            ...
            <div className="w-3/5 text-neutral-500	pt-12 text-left pr-16 ml-16">
                 <div className="container">
                    ...
                    <p className="pt-1 pb-3 ">
                    Si bien todas las estructuras son de concreto, esto es sencillamente el lienzo sobre el cual él pinto su obra. Tanto en las formas que dio al concreto, como todos los elementos con los que decidió acompañarle
                    </p>
                    <p className="pt-1 pb-3 ">
        ...
        <div className="flex ">
            ...
            <div className="w-3/5 text-neutral-500	pt-6 text-left pr-16 ml-16">
                 <div className="container pb-10">
                    ...
                    <p className="pt-1 pb-1">
                    La protección solar se convirtió en un tema en sí mismo, el uso de parasalones o brisoles. Las aperturas en las paredes no son meras entradas de luz son ventanas de distintos tipos, son entramados de bloques, son un delicado juego que cambia según la dirección y el espacio que acompaña. 
                    </p>
                    <p className="pt-1 pb-1">
...
export default MaterialidadInformacion;