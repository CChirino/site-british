    ...
    <div>
        ...
        <div className="flex ">
            ...
            <div className="w-3/5 text-neutral-500 pt-12 text-right mr-20 ml-32">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">La colección “Síntesis de las Artes”</h2>
      ...
      <div className="bg-zinc-50">
        <div className="flex ">
            <div className="w-2/5">
                <div className="container pl-16 pr-16">
                    <img src="/static/images/vitral leger Biblioteca central.JPG"  className="w-7/12 pb-5 pt-16" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500 text-right mr-20 ml-32">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">La pertinencia del arte</h2>
      ...
      <div className="bg-zinc-50">
        <div className="flex pt-12">
            <div className="w-2/5">
                <div className="container pl-16 pr-16">
                    <img src="/static/images/ab010.jpg"  className="w-7/12 pb-5 pt-16" alt="" />
                </div>
            </div>
            <div className="w-3/5 text-neutral-500 text-right mr-20 ml-32">
                 <div className="container pb-10">
                    <h2 className=" pb-10 subtitle-section mr-10 ml-10">Los artistas disidentes</h2>
                    <p className="pt-1 pb-1 mr-10 ml-10 text-justify">
                    ...
                    <h3 className="mr-10 ml-10 subtitle-section-small ">Artistas nacionales:</h3>
                    <p className="pt-1 pb-1 mr-10 ml-10 text-justify">
                    ...
                    <h3 className="mr-10 ml-10 subtitle-section-small">Artistas internacionales:</h3>
                    <p className="pt-1 pb-1 mr-10 ml-10 text-justify">
