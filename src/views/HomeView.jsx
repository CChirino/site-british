        ...
        <div className="flex">
          ...
          >
            {hoveredColumn === 0 ? (
              ...
              <img
                src="/public/static/images/Reloj1-24.png"
                alt=""
          ...
          >
            {hoveredColumn === 1 ? (
              <div>
                ...
                <img
                  src="/public/static/images/CRV-24.png"
                  alt=""
                  className="hovered-images"
                />
              </div>
              ...
              <img
                src="/public/static/images/CRV1-24.png"
                alt=""
                className="home-images"
              />
            )}
            ...
            {hoveredColumn === 2 ? (
              <div>
               <h2 className="absolute top-36 left-1/6 right-1/6 mr-24 ml-24  text-2xl	text-gray-500 text-center	">Arquitectura, <br/> Arte y Paisaje</h2>
                <img
                  src="/public/static/images/Nubes-24.png"
                  alt=""
                  className="hovered-images"
                />
              </div>
              ...
              <img
                src="/public/static/images/mockup EVA-67 (1).png"
                alt=""
                className="home-images"
              />
            )}
            ...
            {hoveredColumn === 3 ? (
              <div>
               <p className="absolute top-36 left-1/6 right-1/6 mr-16 ml-16 text-2xl	text-gray-500 text-center	">EVA: <br/> Experiencia Virtual <br /> Arquitectonica</p>
                <img
                  src="/public/static/images/Pastor-24.png"
                  alt=""
                  className="hovered-images"
                />
              </div>
              ...
              <img
                src="/public/static/images/mockup EVA-68.png"
                alt=""
                className="home-images"
              />
            )}
